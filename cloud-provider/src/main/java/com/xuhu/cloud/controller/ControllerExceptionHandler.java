...
public class ControllerExceptionHandler {
    ...
    public Result bizErrorHandler(HttpServletRequest req, BizException e) {
        log.error("cloud-provider业务异常,reqMethod:{},URI:{},异常信息:{}", req.getMethod(), req.getRequestURI(), e.getErrMsg());
    ...
    public Object defaultErrorHandler(HttpServletRequest req, Throwable e) {
        log.error("cloud-provider内部错误,reqMethod:{},URI:{},异常堆栈:{}", req.getMethod(),
